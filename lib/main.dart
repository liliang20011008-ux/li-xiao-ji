...
礼小记（以下简称“本应用”）由礼小记团队（以下简称“开发者”或“我们”）开发并运营。我们重视用户的个人信息与隐私保护。本政策用于说明本应用如何处理信息、使用系统权限，以及用户如何管理自己的数据。
...
礼小记（以下简称“本应用”）由礼小记团队（以下简称“开发者”或“我们”）开发并运营。
